...
TextStyle getLightStyle(
    {double fontSize = FontSize.s12, required Color color,String fontFamily='BalooThambi400'}) {
  return _getTextStyle(fontSize, FontWeightManager.light, color,fontFamily);
}

// return bold style
TextStyle getBoldStyle({double fontSize = FontSize.s12, required Color color,String fontFamily='BalooThambi800'}) {
  return _getTextStyle(fontSize, FontWeightManager.bold, color,fontFamily);
}

// return semi bold style
TextStyle getSemiBoldStyle(
    {double fontSize = FontSize.s12, required Color color,String fontFamily='BalooThambi800'}) {
