...
class LogoutConfirmationDialogue extends StatefulWidget {
  const LogoutConfirmationDialogue({super.key});

  @override
  State<LogoutConfirmationDialogue> createState() =>
      _LogoutConfirmationDialogueState();
}

class _LogoutConfirmationDialogueState
    extends State<LogoutConfirmationDialogue> {
