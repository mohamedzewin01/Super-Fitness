      ...
      child: Column(
        children: [
          ...
          WheelSlider.number(
            ...
            unSelectedNumberStyle: getSemiBoldStyle(color: ColorManager.white, fontSize: 25.0),
            selectedNumberStyle: getSemiBoldStyle(color: ColorManager.orange, fontSize: 40.0),
