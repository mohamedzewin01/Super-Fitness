...
class CustomStepThree extends StatefulWidget {
  const CustomStepThree({super.key, required this.viewModel});

  final ViewModelCubit viewModel;

  @override
  State<CustomStepThree> createState() => _CustomStepThreeState();
}

class _CustomStepThreeState extends State<CustomStepThree> {
