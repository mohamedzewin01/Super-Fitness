...
class CustomStepTwo extends StatefulWidget {
  const CustomStepTwo({super.key, required this.viewModel});

  final ViewModelCubit viewModel;

  @override
  State<CustomStepTwo> createState() => _CustomStepTwoState();
}

class _CustomStepTwoState extends State<CustomStepTwo> {
...
List<int> ageList = List.generate(80  , (index) => index);
