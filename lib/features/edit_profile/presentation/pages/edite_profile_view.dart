...
class EditeProfileView extends StatefulWidget {
  const EditeProfileView({super.key, required this.profileViewModel});
  ...
  Widget build(BuildContext context) {
    return PopScope(
      onPopInvokedWithResult: (didPop, result) {
         widget.profileViewModel.getProfileData( "Bearer ${CacheService.getData(key: CacheConstants.userToken)}");
      },
